...
| `eesti-keel` | Alati aktiivne | Tagab, et kogu eestikeelne väljund kõlab emakeelsena, mitte tõlgituna. Kehtib automaatselt. |
...
└── .claude/
    ...
    └── skills/                      ← KÕIK oskused elavad siin (üks koht)
        ...
        └── eesti-keel/SKILL.md       ← alati aktiivne, emakeelne eesti keel
```
